const appInfoDefect = Vue.createApp({
    data() {
        return {
          textLength: 0,
          defect_id: '0',
      ...
      mounted() {
        ...
        var myModal = document.getElementById('InfoDefectModalWindow')
        myModal.addEventListener('hidden.bs.modal', function (event) {
          appInfoDefect.clearData();
      })
      }, 
      methods: {
          ...
          Swal.fire({
            ...
            if (result.isConfirmed) {
              data = {
                ...
                "comment": {
                  "comment": 'Комментарий для локализованного дефекта: ' + this.cardComment
                }
              }
              axios
