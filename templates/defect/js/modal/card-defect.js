      ...
      updateCardDefect() {
        axios
          ...
          .then(response => {
            ...
            this.cardRepairManager = this.cardDefect.defect_repair_manager ? this.cardDefect.defect_repair_manager.user_surname + ' ' + this.cardDefect.defect_repair_manager.user_name + ' (' + this.cardDefect.defect_repair_manager.user_division.division_name + ')': '';
            this.cardDatePlannedFinish = this.cardDefect.defect_planned_finish_date;
            this.cardPPR = this.cardDefect.defect_ppr;
            this.cardWorker = this.cardDefect.defect_worker ? this.cardDefect.defect_worker.user_surname + ' ' + this.cardDefect.defect_worker.user_name + ' (' + this.cardDefect.defect_worker.user_division.division_name + ')': '';
